...
func seedPipelines(ctx context.Context, db *database.Client) {
	...
	pipelines := []domain.Pipeline{
		{
			Name: "DATA PIPELINE V2.4", Status: "operational", Latency: "24ms",
			...
			Nodes: []domain.PipelineNode{
				{NodeID: "IN-240-A1", Label: "INGEST", Name: "Intake Node", Type: domain.NodeTypeProcess, Icon: "download",
					Config: domain.PipelineNodeConfig{APIIntegration: "File System Watcher", SuccessRedirect: "Extract Node", DataTypeMatching: true}},
				{NodeID: "EX-240-B2", Label: "PROCESS", Name: "Extract Node", Type: domain.NodeTypeProcess, Icon: "extract",
					Config: domain.PipelineNodeConfig{StrictJSONSchema: true, DataTypeMatching: true, APIIntegration: "OCR Engine v4.2", SuccessRedirect: "Validate Node"}},
				{NodeID: "VN-240-X9", Label: "REVIEW", Name: "Validate Node", Type: domain.NodeTypeReview, Icon: "validate",
					Config: domain.PipelineNodeConfig{StrictJSONSchema: true, DataTypeMatching: true, APIIntegration: "Main Oracle Database", SuccessRedirect: "Transform Node"}},
				{NodeID: "TN-240-C3", Label: "PROCESS", Name: "Transform Node", Type: domain.NodeTypeProcess, Icon: "transform",
					Config: domain.PipelineNodeConfig{StrictJSONSchema: true, DataTypeMatching: true, HandleNullValues: true, APIIntegration: "Data Normalizer", SuccessRedirect: "Export Node"}},
				{NodeID: "EP-240-D4", Label: "EXPORT", Name: "Export Node", Type: domain.NodeTypeExport, Icon: "upload",
					Config: domain.PipelineNodeConfig{APIIntegration: "S3 Bucket Output"}},
			},
		},
	}

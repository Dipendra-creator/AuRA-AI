...
const PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    ...
    models: [
      // ── Free tier (available with any PAT with models:read) ──
      { value: 'gpt-4o-mini', label: 'GPT-4o Mini — fast & affordable' },
      { value: 'gpt-4o', label: 'GPT-4o — multimodal flagship' },
      { value: 'gpt-4.1-nano', label: 'GPT-4.1 Nano — fastest, lowest cost' },
      { value: 'gpt-4.1-mini', label: 'GPT-4.1 Mini — balanced performance' },
      { value: 'gpt-4.1', label: 'GPT-4.1 — best quality coding & instruction' },
      { value: 'DeepSeek-R1', label: 'DeepSeek R1 — open-weight reasoning' },
      { value: 'DeepSeek-R1-0528', label: 'DeepSeek R1 0528 — improved reasoning' },
      ...
      { value: 'MAI-DS-R1', label: 'MAI-DS-R1 — Microsoft-tuned DeepSeek R1' },
      { value: 'mistral-small-2503', label: 'Mistral Small 3.1 — fast multilingual' },
      // ── Copilot Pro required ──
      { value: 'gpt-5-nano', label: 'GPT-5 Nano — ⚠ Copilot Pro required' },
      { value: 'gpt-5-mini', label: 'GPT-5 Mini — ⚠ Copilot Pro required' },
      { value: 'gpt-5', label: 'GPT-5 — ⚠ Copilot Pro required' },
      { value: 'o4-mini', label: 'o4-mini — ⚠ Copilot Pro required' },
      { value: 'o3-mini', label: 'o3-mini — ⚠ Copilot Pro required' },
      { value: 'o3', label: 'o3 — ⚠ Copilot Pro required' }
    ],
